...
//         const selectedDateValue = dateString ? dateString : moment().format('YYYY-MM-DD');
//         setSelectedDate(selectedDateValue);
//         fetchAttendanceData(selectedDateValue);
//         fetchTeachersWithoutAbsents(selectedDateValue); // Fetch ulang untuk tab guru yang belum absen
//     };
...
//     // Define the table columns for both tabs
//     const columns = [
//         {
//             title: "No",
//             dataIndex: "id",
